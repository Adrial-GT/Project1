...
// ------------------------------
    ...
    // -------------------------
    Shader shader("C:\\Users\\Adrial\\Desktop\\opengl\\LearnOpenGL\\src\\1.getting_started\\7.3.camera_mouse_zoom\\5.2.framebuffers.vs", "C:\\Users\\Adrial\\Desktop\\opengl\\LearnOpenGL\\src\\1.getting_started\\7.3.camera_mouse_zoom\\5.2.framebuffers.fs");
    Shader screenShader("C:\\Users\\Adrial\\Desktop\\opengl\\LearnOpenGL\\src\\1.getting_started\\7.3.camera_mouse_zoom\\5.2.framebuffers_screen.vs", "C:\\Users\\Adrial\\Desktop\\opengl\\LearnOpenGL\\src\\1.getting_started\\7.3.camera_mouse_zoom\\5.2.framebuffers_screen.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 newcameraPos = glm::vec3(0.0f, 0.0f, -10.0f); // 位于第一个镜子的背后
        glm::vec3 newcameraFront = glm::vec3(0.0f, 0.0f, 1.0f); // 镜子反射方向
        glm::vec3 newcameraUp = glm::vec3(0.0f, 1.0f, 0.0f); // 上方方向
